...
<head>
  ...
  <title>Bagus & Asha | Undangan Pernikahan</title>
...
<body>
        ...
        <div class="modal-body bg-wakwak p-0">
          <div class="row justify-content-center mt-0 text-center h-100" id="front-image-container">
            ...
            <div class="flex col-md-6 col-12 mt-auto mb-auto" id="front-text">
              ...
              <h1 class="font-dancing fs-60">Asha Aprilia Putri <br/>&<br /> Bagus Aji Santoso, S.Pd.</h1>
              <small class="mt-3">Sabtu, 31 Desember 2022</small>
  ...
  <header class="bg-wakwak">
    <div class="d-flex justify-content-center align-items-center vh-100"
      style="background-image: url(img/img7.png); background-size: cover">
      <div class="container">
        <div class="row text-center">
          <div class="col-12 mt-5">
            The Wedding of
            <h1 class="font-dancing fs-60">Asha & Bagus</h1>
            <p>Sabtu, 31 Desember 2022</p>
          </div>
          <div class="col-12">
    ...
    <div class="container py-5">
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1100">
          ...
          <h1 class="font-dancing text-dark fs-45">Asha Aprilia Putri</h1>
          <p class="m-0 p-0">Putri Bungsu</p>
          <p class="m-0 p-0">Bapak Asep Suryadi & Ibu Lia Yuliawati</p>
        </div>
        ...
        <div class="col-md-5 col-12 my-md-4 my-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          ...
          <h1 class="font-dancing text-dark fs-45">Bagus Aji Santoso, S.Pd.</h1>
          <p class="m-0 p-0">Putra Pertama</p>
          <p class="m-0 p-0">Bapak Susanto, S.Pd. & Ibu Eni Ruminingsih, S.Pd.SD</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-6 col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="500">
          <div class="card p-3 shadow bg-fee">
            ...
            <p class="fw-bold p-0 m-0">Sabtu, 31 Desember 2022</p>
            <p class="m-0 p-0">Pukul 09.00 WIB</p>
            <p class="m-0 p-0">Kec. Cicurug, Kab. Sukabumi, Jawa Barat, Indonesia</p>
          </div>
        </div>
        ...
        <div class="col-12 py-3" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          ...
          <p class="text-white">
            Gedung Serbaguna (Samping Cicatih Waterpark), Desa Bangbayang, Kec. Cicurug, Kabupaten Sukabumi, Jawa Barat
            43359
          </p>
          <a href="https://goo.gl/maps/T2Sbim7vyA8BcGwk6" target="_blank"
          ...
          <div class="map-responsive">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d283.84985671896175!2d106.77719404853414!3d-6.781046463467222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69cdb663a4ec03%3A0xdef753864bd6b880!2sCicatih%20Waterpark!5e0!3m2!1sid!2sid!4v1667141699704!5m2!1sid!2sid"
      ...
      <div class="row text-center justify-content-center">
        ...
        <div class="col-md-6 mb-3 blur" data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1000">
          <div class="card bg-fee rounded-3 shadow p-3">
            <img src="img/bni.png" height="50px" alt="" class="mx-auto" />
            <hr />
            <p><span><input type="text" value="1368855496" class="bg-fee norek" id="rek1" readonly /></span> a/n Asha Aprilia Putri</p>
            <div>
      ...
      <div class="row text-center justify-content-center">
        <div class="col-lg-9 col-md-11 col-12">
          ...
          <div data-aos="zoom-in" data-aos-duration="1300" data-aos-delay="1250">
            <h1 class="font-dancing fs-60">Asha Aprilia Putri</h1>
            <h1 class="font-dancing fs-60">&</h1>
            <h1 class="font-dancing fs-60">Bagus Aji Santoso, S.Pd.</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- <footer class="bg-kulit">
    <div class="container pb-5">
      <div class="row text-center">
        <div class="col-12">
          <small class="p-0 m-0">
            Original Design by <a target="_blank" href="https://github.com/aldiui">Aldi Jaya Mulyana</a> | 2022
          </small>
        </div>
      </div>
    </div>
